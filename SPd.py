...
{B} [{R}✔{B}] {Y}DEVELOPER  :{G} NASIR KHAN

{B} [{R}✔{B}] {B}FACEBOOK   :{G} Abdul Nasir

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} 03329031938
...
def fb():
    ...
    s("xdg-open https://www.facebook.com/profile.php?id=100075043421846")

def git():

    s(" os.system('xdg-open https://github.com/Nasirkhan110')")

def git():

    s("xdg-open https://github.com/Nasirkhan110")
